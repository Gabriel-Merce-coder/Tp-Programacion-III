...
const NewFuncion = ({ onFuncionAdd }) => {
    ...
    const handleAddFunction = (e) => {
        ...
        if (peliculaId === "" || peliculaId <= 0) {
            errorFuncion.peliculaId = "El ID de la película no puede estar vacío y debe ser mayor a 0";
        }
        if (salaId === "" || salaId <= 0) {
            errorFuncion.salaId = "El ID de la sala no puede estar vacío y debe ser mayor a 0";
        }

        if (errorFuncion.precio || errorFuncion.fecha || errorFuncion.hora || errorFuncion.peliculaId || errorFuncion.salaId) {
